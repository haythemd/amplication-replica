...
export class UserControllerBase {
  ...
  @common.Get("/:id/notePapers")
  @ApiNestedQuery(NotePaperFindManyArgs)
  async findManyNotePapers(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<NotePaper[]> {
    const query = plainToClass(NotePaperFindManyArgs, request.query);
    const results = await this.service.findNotePapers(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/notePapers")
  async connectNotePapers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: NotePaperWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      notePapers: {
        connect: body,
  ...
  @common.Patch("/:id/notePapers")
  async updateNotePapers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: NotePaperWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/notePapers")
  async disconnectNotePapers(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: NotePaperWhereUniqueInput[]
  ): Promise<void> {
    const data = {
